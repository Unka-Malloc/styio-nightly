...
100. When a Better Plan follow-up is repaired and verified in the owned implementation, move it from the incomplete to completed inventory in `docs/plan/README.md` and record the repair evidence in its semantic plan projection; keep externally blocked plans explicitly listed with their blocker.
