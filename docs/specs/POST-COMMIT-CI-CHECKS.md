...
python3 ../styio-spio/scripts/ecosystem-product-gate.py --workspace-root /home/unka
python3 ../styio-spio/scripts/ecosystem-sample-workflow-gate.py --workspace-root /home/unka
```
